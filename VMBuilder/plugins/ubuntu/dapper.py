...
class Dapper(suite.Suite):
    ...
    def prevent_daemons_starting(self):
        os.chmod(self.install_from_template('/usr/sbin/policy-rc.d', 'nostart-policy-rc.d'), 0o0755)
    ...
    def install_menu_lst(self, disks):
        logging.info("BEG of install_menu_lst =====================================================")
        ...
        logging.info("END of install_menu_lst =====================================================")

    def mangle_grub_menu_lst(self, disks):
        logging.info("BEG of mangle_grub_menu_lst =====================================================")
        ...
        logging.info("END of mangle_grub_menu_lst =====================================================")
    ...
    def install_kernel(self, destdir):
        logging.info("BEG of install_kernel =====================================================")
        try:
            self.run_in_target('mount', '-t', 'proc', 'proc', '/proc')
        ...
        logging.info("END of install_kernel =====================================================")
